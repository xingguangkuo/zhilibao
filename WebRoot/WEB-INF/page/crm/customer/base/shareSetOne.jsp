...
<body>
<s:form name="ActionForm" method="post" action="companyAction_updateShareSetOne.do"  namespace="/crm">
<s:hidden id="id" name="id" value="%{#request.company.id}"></s:hidden>
<div class="mtitle">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#6A82A8">
	<tr>
		<td align="center" height="25"><span class="Tabfont"><s:property value="%{#request.company.name}"/>(客户)待共享的模块</span></td>
	</tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="center" height="25"><span class="Tabfont"><s:property value="%{#request.company.name}"/>(客户)待共享的用户</span></td>
	</tr>
</table>
