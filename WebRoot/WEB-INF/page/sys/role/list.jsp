...
function setMenu(id) {
	OpenWin('${pageContext.request.contextPath}/sys/sysRoleAction_listMenu.do?roleId='+id,'',800,600);
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" name="base" id="base">
	<tr>
    	<td width="38%" nowrap>名称：
			<s:textfield name="name" id="name"  cssStyle="width:140px"></s:textfield>
    	</td>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" id="PowerTable" class="PowerTable">
       ...
       <s:if test="%{#request.sysRoles!=null}">
          <s:iterator value="%{#request.sysRoles}" var="sysRole"> 
			<tr> 
		    	<td>
		    	  <s:checkbox name="ids" fieldValue="%{#sysRole.id}"  cssClass="checkbox" onclick="changeCheckCount();"></s:checkbox>
				</td>
