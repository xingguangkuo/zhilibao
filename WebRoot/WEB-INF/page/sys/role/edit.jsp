...
<body>
<s:form name="form1" method="post" action="sysRoleAction_update.do" namespace="/sys">
  ...
  <tr>
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td class="red">名称</td>
				<td><s:textfield name="name"  cssClass="input" id="name" cssStyle="width:90%"></s:textfield>
				</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				...
				<td colspan="3">
				<s:textarea  name="remark" rows="3" id="remark" cssStyle="width:96%"></s:textarea>
				</td>
			</tr>
  		</table>
		</div>
