...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabForm">
  ...
  <tr>
  <td colspan="2">
<s:form name="form1" method="post" action="sysUserGroupAction_list.do" namespace="/sys">
	  ...
	  <s:iterator value="%{#request.sysUserGroups}" var="sysUserGroup"> 
		<tr>
	    	<td>
	  	    ...
	  	    <td><a href="${pageContext.request.contextPath}/sys/sysUserGroupAction_edit.do?id=<s:property value="%{#sysUserGroup.id}"/>"><s:property value="%{#sysUserGroup.name}"/></a></td>
