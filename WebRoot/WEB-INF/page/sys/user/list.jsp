...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabForm">
  ...
  <tr>
	  <td colspan="2">
<s:form name="form1" method="post" action="sysUserAction_list.do" namespace="/sys">
	  ...
	  <s:iterator value="#request.sysUserList" var="sysUser">
		<tr>
	    	<td>
	  	    ...
	  	    <td><a href="${pageContext.request.contextPath}/sys/sysUserAction_edit.do?id=<s:property value="#sysUser.id"/>"><s:property value="#sysUser.name"/></a></td>
