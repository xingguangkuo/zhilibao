  	...
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td><input name="module" type="text" class="input" id="module" style="width:90%"></td>
				<td class="red">数据库表名：</td>
				<td><input name="tab_name" type="text" class="input" id="tab_name" style="width:90%"></td>
			</tr>
			<tr>
				<td class="red">编码前缀：</td>
				<td>
					<input name="area_prefix" type="text" class="input" id="area_prefix" style="width:90%">
				</td>
				<td class="red">流水位：</td>
