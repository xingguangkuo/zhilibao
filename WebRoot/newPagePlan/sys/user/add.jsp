...
<body>
<s:form name="form1" method="post" action="sysUserAction_save.do"  namespace="/sys">
<div class="mtitle">
...
<div class="control">
	...
	<button type='button' class='button' onMouseOver="this.className='button_over';" 
	        onMouseOut="this.className='button';"  onClick="forward('user.do?method=list')">
  	...
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td class="red">中文名：</td>
				<td><s:textfield  name="cnname"  cssClass="input" id="cnname" cssStyle="width:90%"/></td>
			</tr>
			<tr>
				<td class="red">密码：</td>
				<td> <s:password name="password" id="password" cssStyle="width:90%" /></td>
				<td>推荐人：</td>
  ...
  <tr>
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td>修改人：</td>
				<td><s:textfield  name="updater"  cssClass="disabled" id="updater" readonly="true"/>
				</td>
				<td>修改时间：</td>
				<td><s:textfield  name="updateTime"  cssClass="disabled" id="updateTime" readonly="true"/>
				</td>
			</tr>
  		</table>
		</div>
