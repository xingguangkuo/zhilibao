...
<body>
<form name="form1" method="post" action="${pageContext.request.contextPath}/sys/sysUserGroupAction_update.do" >
...
<div class="control">
	...
	<button type='button' class='button' onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  
	        onClick="forward('group.do?method=list')"><img src="${pageContext.request.contextPath}/ui/images/button/fanhui.png" border='0' align='absmiddle'>&nbsp;返回</button>
</div>
  	...
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td><input name="name" type="text" class="input" id="name" value="" style="width:90%"></td>
				<td>部门负责人</td>
				<td><input name="principal" type="text" class="input" id="principal" style="width:90%" value=""></td>
			</tr>
			<tr>
				<td height="40" valign="top">部门职能</td>
				<td colspan="3"><textarea name="incumbent" rows="3" id="incumbent" style="width:96%"></textarea></td>
			</tr>
			<tr>
