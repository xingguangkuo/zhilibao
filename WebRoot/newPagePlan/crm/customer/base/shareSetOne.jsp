...
<div class="mtitle">
	<div class="mtitle-row">&nbsp;</div>
		<span onClick="" class="menu_selected">共享设置</span>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="center" height="25"><span class="Tabfont">${company.name}(客户)待共享的用户</span></td>
	</tr>
</table>
<div class="border" style="padding:3px">
			<fieldset style='padding:5px;clear:left;'>
					 <legend>销售部</legend>
                          <div>
						   <input type='checkbox' class='checkbox' name='uid' value='10' id='uid10'  onclick='do_select(this.id)' >王卓
						  </div>&nbsp;
                          <div>
						   <input type='checkbox' class='checkbox' name='uid' value='11' id='uid11'  onclick='do_select(this.id)' >李瓶儿
						  </div>&nbsp;
			</fieldset>
			...
			<fieldset style='padding:5px;clear:left;'>
					 <legend>技术部</legend>
                          ...
                          <div>
						   <input type='checkbox' class='checkbox' name='uid' value='12' id='uid12'  onclick='do_select(this.id)' >潘金莲
						  </div>&nbsp;
                          <div>
						   <input type='checkbox' class='checkbox' name='uid' value='13' id='uid13'  onclick='do_select(this.id)' >吴春梅
						  </div>&nbsp;
					                   
			</fieldset>
		
			<fieldset style='padding:5px;clear:left;'>
					 <legend>CEO办公室</legend>
                          <div>
						   <input type='checkbox' class='checkbox' name='uid' value='9' id='uid9'  onclick='do_select(this.id)' >系统管理员
						  </div>&nbsp;
			</fieldset>
