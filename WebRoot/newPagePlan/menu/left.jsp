	...
	<div id="sidetreecontrol"><a href="?#">Collapse All</a> | <a href="?#">Expand All</a></div>
		<ul id="tree">
					...
					<ul>
						           ...
						           <a href="${pageContext.request.contextPath}/crm/customer/base/list.jsp" target="rightFrame">客户拜访</a></li>
					...
					<ul>     
						           ...
						           <a href="${pageContext.request.contextPath}/sys/group/list.jsp" target="rightFrame">部门设置</a></li>
						           <li><img src="${pageContext.request.contextPath}/ui/images/menu/rsgl.png" width="17" height="17">
						           <a href="${pageContext.request.contextPath}/sys/user/list.jsp" target="rightFrame">人事管理</a></li>
						           <li><img src="${pageContext.request.contextPath}/ui/images/menu/czqxz.png" width="17" height="17">
						           <a href="${pageContext.request.contextPath}/sys/role/list.jsp" target="rightFrame">操作权限组</a></li>
